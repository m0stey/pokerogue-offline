...
// online, and if there is something newer than what we serve, one plain German message telling her
 ...
 * must say nothing, because a wrong "there is a new version" message sends her looking for an
