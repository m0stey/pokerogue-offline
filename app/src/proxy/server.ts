...
export async function startProxy(opts: ProxyOptions): Promise<ProxyHandle> {
   ...
   * a browser on pokerogue.net is enough to cause it. We cannot prevent it — the save is the user's and
   * the modal is the client's — but the shell can say what happened, in words the user can act on.
   */
