 ...
 * i.e. answering the 503 we used to answer tore down the game-over screen at the exact moment she
 ...
 * Deliberately tolerant about slot and clientSessionId — an error here costs her the end of a run,
