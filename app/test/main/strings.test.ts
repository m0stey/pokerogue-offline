// The words the user reads. These tests are not about wording taste — they guard the two rules the
...
describe("the German strings", () => {
  ...
  it("tells the user who to ask about a new version, and that nothing is lost", () => {
