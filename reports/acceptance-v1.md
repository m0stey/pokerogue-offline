...
- When PokéRogue releases a new version and she plays it in the browser, the app shows a German notice and she needs a new installer from Alexander. Nothing is lost meanwhile.
...
- Offline, the app does not check the password; anyone using her Windows account can open the game.
